...
int main(int,char**){
  ...
  Image* images2 = new Image(game.renderer, "../assets/images/cenarios/bolona_rocha.jpg", true, std::make_pair(0, 0), 1);
  ...
  Animation* images4 = new Animation(game.renderer, "../assets/images/sprites/fox_running_right.png", true, std::make_pair(0, 0),1,1,9,0.9,true,"RIGHT");
  Animation* images5 = new Animation(game.renderer, "../assets/images/sprites/fox_running_left.png", false, std::make_pair(0, 0),1,1,9,0.9,true,"LEFT");
